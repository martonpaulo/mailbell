...
- App icon generated with [IconKitchen](https://icon.kitchen/i/H4sIAAAAAAAAA0VRTWuDQBD9L9OrlBjRWG8lSXsqFNpbCGXdLxd0R9Y1JIj_vbMbTU7OPN7HPHeCC2tHOUA1gdJ7bNFBBS9qp7ZKQQL1EytYJmQZsd9bLwnSjgkjrY_Y57qQ0-Cxj5abKBSZVFsipXF7zw7HEuYEmNUt2WRpTkutv-TQBE2PxnpSnya4QrV53eYJ3NaBr9fkWXH4OJLNwtqtrDA8WGvYOSb8NCzezY3jlJxQ46UJb03PXCzChJaPzqmQb3Vx7yyvfnREnshL6W8mhLE6HExloUrLBJzRDfUPY43eY3efW6kiGnX7JSn8JUkfcDhaQQmGo6XVojfKcOYN2uGPcW8uEmaSdijGNjzUCTrGcYDz_A-zAqzyvQEAAA) using the `notifications_active` round clipart icon, foreground `#F7F2FF`, 18% padding, no effect, and a `#6D3EF2` gradient background at 315 degrees with no texture.
